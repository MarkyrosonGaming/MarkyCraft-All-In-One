...
*/
public class Stores {
	protected static Inventory shop;		// Creates shop inventory
	protected static Inventory navigator;   // Creates server navigator inventory
	protected static Inventory books;		// Creates books inventory
