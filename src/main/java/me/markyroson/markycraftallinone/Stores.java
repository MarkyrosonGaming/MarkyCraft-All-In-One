...
public class Stores {
    ...
    private static void Shop()    // Shop/store setup
    {
        ...
        shop.setItem(3, Api.createItem(Material.END_STONE, 32, 0, ChatColor.AQUA + "EndStone", ChatColor.WHITE + "Price: " + ChatColor.GOLD + "$150", ChatColor.WHITE + "Right Click to sell for " + "$50"));
